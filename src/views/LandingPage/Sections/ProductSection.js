            ...
            <Grid container spacing={4} justify="center">
                <Grid item xs={12} sm={12} md={8}>
                    ...
                    <h5 className={classes.description}>
                        ...
                        Nous nous rendons toutes les semaines à pleins d’endroits différents: au travail, au magasin, pour rencontrer des amis, la famille, se promener, faire du sport, etc. Et du coup nous faisons tous des trajets récurrents, nous laissons notre voiture dans des parkings, etc.
                        En plus, notre voiture est vue par beaucoup de monde, que ce soit les piétons, les autres usagers de la route, dans les embouteillages ou aux feux rouges.
                        On dit que dans une grande ville, une voiture peut être vue jusqu’à … fois. Tu ne le pensais pas non?
                        Alors voilà, notre concept est d’offrir une grande visibilité aux entreprises sur un support innovant: ta voiture!
